...
const singing_1 = require("../singing/singing");
var COMMAND_TYPE;
    ...
    if (trusted === false) {
        ...
        switch (prefix) {
            ...
            case COMMAND_TYPE.SING: {
                ...
                await singing_1.Singing.fromPreprocessed(payload);
                return HANDLE_STATUS.HANDLED;
            }
            case COMMAND_TYPE.SING_YT: {
                await singing_1.Singing.fromYoutube(payload);
                return HANDLE_STATUS.HANDLED;
            }
            case COMMAND_TYPE.SING_RANDOM: {
                ...
                if (picked_song === "")
                    return HANDLE_STATUS.HANDLED;
                await singing_1.Singing.fromPreprocessed(picked_song);
                return HANDLE_STATUS.HANDLED;
            }
