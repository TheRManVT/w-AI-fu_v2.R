...
/**
 * Class mirroring the structure of the config files in the `userdata/config/`
 * folder.
 * Used for validating incoming config files.
 */
export class Config {
    "_" = {
    ...
    /** @see `./available_presets.ts` */
    static getAllPresets = getAllPresets_impl;
    /** @see `./get_last_preset.ts` */
...
export class ConfigFieldVtsEmotionList implements IConfigField {
    ...
    "hint": string = "";
    "reload": boolean = false;
    "type": string = "vts_emotions_list" as const;
    "default": VtsEmotion[] = [];
    "value": VtsEmotion[] = [];
}
...
export class ConfigFieldVtsKeywordTriggersList implements IConfigField {
    ...
    "hint": string = "";
    "reload": boolean = false;
    "type": string = "vts_keywords_list" as const;
    "default": VtsKeywordTriggers[] = [];
    "value": VtsKeywordTriggers[] = [];
}
...
export class VtsKeywordTriggers {
    "keywords": string[] = [];
